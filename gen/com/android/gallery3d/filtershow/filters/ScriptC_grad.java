 ...
 * The source Renderscript file: C:\\Users\\KreAc\\Dev\\Katsuna\\packages\\apps\\Gallery2\\src\\com\\android\\gallery3d\\filtershow\\filters\\grad.rs
 */
...
import com.android.gallery3d.filtershow.filters.gradBitCode;
...
public class ScriptC_grad extends ScriptC {
    ...
    public  ScriptC_grad(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              gradBitCode.getBitCode32(),
              gradBitCode.getBitCode64());
    ...
    public Script.InvokeID getInvokeID_setupGradParams() {
        return createInvokeID(mExportFuncIdx_setupGradParams);
    }
